...
public class UserControllerV2 {
    ...
    public ResponseEntity<ListResponseDto<EntityModel<UserPreviewDto>>> getUsers(
        ...
        List<EntityModel<UserPreviewDto>> resources = users.getData().stream().map(com.project1.project1.controller.v1.UserController::toModelP).toList();
    ...
    public static EntityModel<UserPreviewDto> toModelP(UserPreviewDto userDto) {
        return EntityModel.of(userDto,
                linkTo(methodOn(com.project1.project1.controller.v1.UserController.class).getUserById(userDto.getId(), null)).withSelfRel(),
                linkTo(methodOn(com.project1.project1.controller.v1.PostController.class).getPostsByUser(null,userDto.getId(), null,null,null,null,null,null,null)).withRel("posts"),
