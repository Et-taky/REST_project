...
@RestController
@RequestMapping(path = "/v2/posts",produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
public class PostControllerV2 {
    ...
    public ResponseEntity<ListResponseDto<EntityModel<PostPreviewDto>>> getAllPosts(
        ...
        List<EntityModel<PostPreviewDto>> resources = posts.getData().stream().map(com.project1.project1.controller.v1.PostController::toModelP).toList();
    ...
    public static EntityModel<PostFullDto> toModelF(PostFullDto postDto) {
        return EntityModel.of(postDto,
                linkTo(methodOn(com.project1.project1.controller.v1.PostController.class).getPostById(postDto.getId(), null)).withSelfRel(),
                WebMvcLinkBuilder.linkTo(methodOn(com.project1.project1.controller.v1.UserController.class).getUserById(postDto.getOwner().getId(),null)).withRel("owner")
